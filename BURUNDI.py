...
if __name__ == "__main__":
  ...
  reals=[Mahama_real,Nduta_real,Nyarugusu_real,Nakivale_real,Lusenda_real]
  
  simuls=[Mahama_simu,Nduta_simu,Nyarugusu_simu,Nakivale_simu,Lusenda_simu]
...
#########################################################################################################
  ...
  for t in range(0,end_time):
    ...
    for i in range(0,len(camp_locations)):
      ...
      simuls[i].append(locations[camp_number].numAgents)
      reals[i].append(loc_data[i])
