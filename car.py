...
# TODO: I CHANGED IT TO THE DEFAULT!!! ONLY SO I CAN LOOK AT THE NETWROK PROPERTIES!!
# NEED TO FIX THIS BEFORE WE LOOK AT THE SIMULATION!!!!!
  ...
  if GET_PROP is True:
      ...
      locations = list(lm.values())

      camps = ["Brazaville", "East", "Adamaoua", "Gondje", "Amboko", "Dosseye",
                "Betou", "Boyabu", "Mole", "Bili", "Inke", "Belom", "Moyo",
                "Mboti"]
      conflicts = ["Nola", "Berberati", "Carnot", "Bouar", "Bohong", "Bozoum",
                    "Paoua", "Bossangoa", "Bossembele", "Boda", "Bimbo",
  ...
  # print("av", (sum(distances) / 2) / len(distances))
  # quit()
  #
  # paths = []
  # for camp in camps:
